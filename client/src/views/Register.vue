        ...
        <form class="w-full" v-on:submitsubmit.prevent="handleRegister">
            <div class="flex flex-wrap mb-6">
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <p class="text-red text-xs italic" v-if="errors.has('username')">{{ errors.first('username') }}</p>
                </div>
            </div>
            <div class="flex flex-wrap mb-6">
            ...
            <div class="flex flex-wrap mb-6">
                ...
                <div class="w-1/2 px-3">
                    <label :class="(errors.has('passwordConf')) ? 'border-red' : 'border-grey-lighter'"
                    ...
                    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                           id="confirm-password" name="passwordConf" placeholder="******************" type="password"
                           v-model="passwordConf" v-validate="'required|confirmed:password'">
                    <p class="text-red text-xs italic" v-if="errors.has('passwordConf')">{{ errors.first('passwordConf')
                        }}</p>
                </div>
            </div>
            <div class="w-1/2 px-3">
